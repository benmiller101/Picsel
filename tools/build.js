...
const PAGES = [
  {
    ...
    content: `    <section class="hero" id="hero">
      ...
      <div class="hero__stage">
        ...
        <!-- Layer 1: lava-lamp blobs. Paths, gradients and the goo filter are
             all generated by hero.js — see BLOBS in its config block. -->
        <svg id="blobs" class="hero-blobs" aria-hidden="true" preserveAspectRatio="none">
          <defs id="blob-defs"></defs>
          <g id="blob-group"></g>
        </svg>
