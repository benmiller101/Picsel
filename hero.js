...
/* The colour families the blobs draw from. Shared with page-blob.js, which
   paints the smaller blob in the /work/ and /contact/ page heads — see
   palette.js for why blob i is pinned to family i. */
